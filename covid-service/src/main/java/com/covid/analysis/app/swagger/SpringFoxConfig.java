package com.covid.analysis.app.swagger;
...
public class SpringFoxConfig {
    ...
    * */
    ...
    private ApiInfo buildAppInfo() {
        ...
        Contact contact = new Contact("Jappie", "N/A", "jappie@gmail.com");
        ApiInfo apiInfo = new ApiInfo(
                "COVID-19 Data Analysis and Prediction",
                "The system analyse the future report using current coronavirus data received from around the orld.",
                "v1",
